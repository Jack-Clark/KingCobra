...
public class VeriConstants {
	...
	// King Cobra extensions
	public static boolean VERSION_ORDER_ON = false; // consume a version order file (see VERSION_ORDER_PATH)
	public static boolean ALL_VO_EDGES = false;     // materialise the transitive closure of VO edges
	public static boolean CLIENT_ORDER_ON = true;   // emit client-order (CO) edges
	public static String VERSION_ORDER_PATH = "version_order.vo";
	//
	...
	// Online-DB mode only (ONLINE_DB_TYPE=POSTGRESQL). Placeholders: set DB_HOST in the config file and
	// replace the username/password here before use.
	public static String DB_HOST= "localhost";
	public static String PG_USERNAME="CHANGE_ME";
	public static String PG_PASSWORD="CHANGE_ME";
